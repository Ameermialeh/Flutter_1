...
class ChatCardBusiness extends StatefulWidget {
  final VoidCallback press;
  final Map<String, dynamic> user;
  final String userId;
  const ChatCardBusiness(
      {super.key,
      required this.press,
      required this.user,
  ...
  @override
  State<ChatCardBusiness> createState() => _ChatCardBusinessState();
}

class _ChatCardBusinessState extends State<ChatCardBusiness> {
