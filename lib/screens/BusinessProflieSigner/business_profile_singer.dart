...
import 'package:gp1_flutter/screens/UpdateProfileBusiness/update_profile_business.dart';
...
class BusinessProfileSinger extends StatefulWidget {
  const BusinessProfileSinger({super.key});

  @override
  State<BusinessProfileSinger> createState() => _BusinessProfileSingerState();
}

class _BusinessProfileSingerState extends State<BusinessProfileSinger> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      IconButton(
                        onPressed: () {
                          Navigator.pushNamed(context, '/mySong');
                        },
                        icon: const Icon(
